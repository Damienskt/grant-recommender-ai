OUTPUT_FILENAME = "src/grants_stocktake_tool/scraper_output/grants.csv"
POST_PROCESSED_OUTPUT = "src/grants_stocktake_tool/scraper_output/post_processed_grants.csv"
